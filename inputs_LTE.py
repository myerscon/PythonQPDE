...
### GENERAL PARAMETERS ###
##########################
directory_name = 'output_LTE' # output directory name
...
CFL = 0.0008
dt = CFL*(h_value**2)*3 # For 2T problem with units only
...
N_tot = 1500#000 # Total subintervals (for computing n and k)
...
list_constants = ([dz,gamma,c_],[dz_value,3.5,0.01])
